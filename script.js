    ...
    document.getElementById("startButton").addEventListener("click", function () {
        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">Tita, I truly appreciate the time and kindness you've shown me.
						Angel and I have been working on our painting, and is it possible if I could come over to help finish it po.
						I’d love to make sure it turns out well, and of course, I want to be respectful of your time and rules.</p>
						
                        <p class="words line2">- sean <3</p>
                    </div>
                </div>
            </div>
            <div class="continue">
				...
				<style>
					...
					.line1 { top: 15%; }
					.line2 { top: 15%; }
					.line3 { top: 25%; text-align: center; }
        ...
        btnContinue.addEventListener("click", function () {
            content.innerHTML = `
                ...
                <div class="question">
                    <p style="font-size: 24px;">Can i come over again po, tita?</p>
            ...
            noBtn.addEventListener("click", function () {
				content.innerHTML = "<div style='text-align: center;'>" +
					...
					"<p style='font-size: 24px;'>Sige po tita, next time na lang po :(</p>" +
					"</div>";
			});
        });
    });
